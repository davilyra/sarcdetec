...
%    show(freq,3) 
    ...
    plotridgeorient(orientim_perp, 20, im, 8)
    orientim_perp_angles = rad2deg(orientim_perp);
    hist(orientim_perp_angles)
    Mean = mean2(orientim_perp_angles)
    Std = std2(orientim_perp_angles)
